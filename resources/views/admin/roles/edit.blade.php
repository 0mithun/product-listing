                        ...
                        <form role="form" action="{{ route('role.update', $role->id ) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $role->name }}" name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="role_name" placeholder="Enter Role Name">
                                    ...
                                    @foreach ($permission_groups as $group)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9 role-{{ $i }}-management-checkbox">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input onclick="checksinglepermission('role-{{ $i }}-management-checkbox','{{ $i }}management',{{ count($permissionss) }})" {{ $role->hasPermissionTo($permission->name) ? 'checked':'' }} name="permissions[]" class="custom-control-input" type="checkbox" id="permission_checkbox_{{ $permission->id }}" value="{{ $permission->name }}">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success"><i class="fa fa-sync"></i> {{ __('update') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
