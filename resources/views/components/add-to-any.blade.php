    ...
    <div class="a2a_kit a2a_kit_size_20 addtoany_list" data-a2a-url="{{ route('slug.view', nestedPathRemoveFirst($category->slug_path).'/'. $product->slug) }}"
        data-a2a-title="Anchovy Pattern Sphere Vase" style="line-height: 20px;"><a class="a2a_button_email"
            ...
            title="Pinterest" rel="nofollow noopener" target="_blank"><span
                ...
                </svg></span><span class="a2a_label">Pinterest</span></a><a class="a2a_button_print" href="/#print"
            title="Print" rel="nofollow" target=""><span class="a2a_svg a2a_s__default a2a_s_print"
                style="background-color: transparent; width: 20px; line-height: 20px; height: 20px; background-size: 20px; border-radius: 3px;"><svg
                    focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                    <path d="M22.5 19.59V24h-13v-4.41z" fill="#6d6d6d" stroke="#6d6d6d" stroke-linecap="round"
                    ...
                    <path
                        ...
                        fill="none" stroke="#6d6d6d" stroke-linecap="round" stroke-miterlimit="10" stroke-width="1.4">
                    </path>
                    <path d="M22.5 12.32V8h-13v4.28" fill="#6d6d6d" stroke="#6d6d6d" stroke-linecap="round"
                        stroke-miterlimit="10" stroke-width="1.4"></path>
                </svg></span><span class="a2a_label">Print</span></a><a
            href="{{ route('product.print', $product->slug) }}" target="_blank" id="uds"
            style="font-size: 13px; margin-top: -5px;">Print Tear Sheet</a></div>
</div>
