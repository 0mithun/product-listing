    ...
    <div class="container no-pad">
        <div class="row align-top">
                ...
                <nav class="navbar links">
                    <ul class="navbar-nav right">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggler" href="/collections" id="navbarDropdown"
                                role="button">
                                Collections
                            </a>
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown2"><a class="dropdown-item" href="#"
                                        id="dropdown-Accessories">Accessories</a>
                                    <ul class="dropdown-submenu">
                                        <li><a class="dropdown-item"
                                                href="https://hummingbird-ad.com/collections/accessories/candle-holders/">Candleholders</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="https://hummingbird-ad.com/collections/accessories/holiday-ornaments/">Holiday
                                                Ornaments</a></li>
                                    </ul>
                                </li>
                                <li><a class="dropdown-item"
                                        href="https://hummingbird-ad.com/collections/bowls/">Bowls</a></li>
                                <li><a class="dropdown-item"
                                        href="https://hummingbird-ad.com/collections/center-plates-decorative-plates/">Center
                                        Plates/Decorative Plates</a></li>
                                <li class="dropdown-item"><a
                                        href="https://hummingbird-ad.com/collections/jewelry/necklaces/">Necklaces</a>
                                </li>
                                <li><a class="dropdown-item"
                                        href="https://hummingbird-ad.com/collections/tableware/">Tableware</a></li>
                                <li><a class="dropdown-item"
                                        href="https://hummingbird-ad.com/collections/vases/">Vases</a></li>
                            </ul>
            ...
            <div class="col-md-4 col-6 text-center ">
                <a href="{{ route('index') }}" class="site-title navbar-brand"><img alt="Hummingbird Art & Design"
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                                ...
                                <li><a class="dropdown-item"
                                        href="https://hummingbird-ad.com/gallery/medium/ceramics/">Italian
                                        Ceramics</a></li>
                                <li><a class="dropdown-item"
                                        href="https://hummingbird-ad.com/collections/jewelry/">Jewelry</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
