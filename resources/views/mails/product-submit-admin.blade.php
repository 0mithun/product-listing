...
<body style="font-family: 'Inter', sans-serif; padding:11px;">
    <h4 align="center"
        ...
        New Product submitted by, {{ $submitted->name }}, {{ $submitted->email }}</h4>
        ...
        <p align="center" style="font-size: 1.2rem; font-weight: 500; margin-bottom: 11px; font-family:lora;   margin-top:25px;">{{ $submitted->message  }}</p>
